...
- The build will be in `FNF-Psych-Engine-Plus/export/release/<target>/bin`, with `<target>` being the target you built to in the previous step. (i.e. `FNF-Psych-Engine-Plus/export/release/windows/bin`)
- Incase you added the -debug flag the files will be inside `FNF-Psych-Engine-Plus/export/debug/<target>/bin`
