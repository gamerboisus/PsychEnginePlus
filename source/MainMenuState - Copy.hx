...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		titleJSON = Json.parse(Paths.getTextFromFile('images/menustuff.json'));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Psych Engine PLUS v" + psychEngineVersion, 12);
