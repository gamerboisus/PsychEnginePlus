...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['0%', 0.1], //From 0% to 19%
		['10%', 0.2], //From 0% to 19%
		['20%', 0.25], //From 20% to 39%
		['20.5%', 0.4], //From 20% to 39%
		['20.9%', 0.45], //From 20% to 39%
		['30%', 0.5], //From 40% to 49%
		['36%', 0.55], //From 40% to 49%
		['40%', 0.6], //From 50% to 59%
		['40.7%', 0.61], //From 40% to 49%
		['50%', 0.69], //From 60% to 68%
		['60%', 0.7], //69%
		['50.5%', 0.71], //From 40% to 49%
		['70%', 0.8], //From 70% to 79%
		['76%', 0.85], //From 70% to 79%
		['80%', 0.9], //From 80% to 89%
		['87%', 0.99], //From 40% to 49%
		['90%', 1], //From 90% to 99%
		['99%', 1], //From 70% to 79%
		['100%', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	//	healthBar.createFilledBar(Open HealthBarColorState);
		add(healthBar);
	    ...
	    var songTxt = new FlxText(12, healthBarBG.y + 50, 0, SONG.song + " - " + storyDifficultyText + "", 18);
        ...
        //judgementCounter = new FlxText(20, 0, 0, "Winning!?!?", 20);
		//judgementCounter = new FlxText(20, 0, 0, "Losing!?!?", 20);
		...
		DiscordClient.changePresence(detailsText
			...
			+ songScore
			+ " | Misses: "
			+ songMisses, iconP2.getCharacter());
		#end
	...
	override public function update(elapsed:Float)
	{
		...
		{
			iconP1.swapOldIcon();
			healthBar.createFilledBar(0xFFFF0000, FlxColor.YELLOW);
		}
	...
	public var ratingName:String = '0';
