...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FirstText = FlxG.random.getObject(getFirstTextShit());
		EndText = FlxG.random.getObject(getEndTextShit());
	...
	function getEndTextShit():Array<Array<String>>
	{
		var fullText:String = Assets.getText(Paths.txt('EndText'));

		var firstArray:Array<String> = fullText.split('\n');
		var Good:Array<Array<String>> = [];
	...
	function getFirstTextShit():Array<Array<String>>
	{
		var fullText:String = Assets.getText(Paths.txt('firstCreditText'));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText(FirstText[1]);
					addMoreText(FirstText[2]);
					addMoreText(FirstText[3]);
					#else
				...
				case 13:
				    #if PSYCH_WATERMARKS
					addMoreText(EndText[0]);
					#else
					addMoreText('Friday');
					#end
				case 14:
				    #if PSYCH_WATERMARKS
					addMoreText(EndText[1]);
					#else
					addMoreText('Night');
					#end
				case 15:
				    #if PSYCH_WATERMARKS
					addMoreText(EndText[2]);
					#else
					addMoreText('Funkin');
					#end
